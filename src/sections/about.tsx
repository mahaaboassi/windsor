...
const About: React.FC =()=>{
    ...
    return(<div id="about" className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-5 container-layout">
        <div className="flex flex-col gap-4 md:gap-10 relative">
            ...
            <h2>SHORT STORY ABOUT OUR COMPANY <span>WINDSOR</span></h2>
            <p>Lorem ipsum dolor sit ametc onsectetur adipiscing elitsed do eiusmod tempor incidunt rarut labore etfa.Lorem ipsum dolor sit ametc onsectetur .</p>
            <motion.div
                ref={ref}
