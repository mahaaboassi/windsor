        ...
        <div className="fixed right-3 bottom-3 xxs:right-6 xxs:bottom-6 z-60 fixed-component">
            <Link target="_blank" aria-label="Whatsapp" to={"https://wa.me/+61419358029"}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 58 58" fill="none">
                    <g filter="url(#filter0_d_2240_1341)">
                    <rect x="4" width="50" height="50" rx="25" fill="white"/>
                    <rect x="5" y="1" width="48" height="48" rx="24" stroke="#A6CE38" stroke-width="2"/>
                    <path className="whatsapp-icon" d="M32.7862 30.7793C27.4074 30.7781 23.0305 26.312 23.0293 20.8248C23.0317 19.4341 24.14 18.302 25.5017 18.302C25.6416 18.302 25.7803 18.3142 25.9118 18.3386C26.2035 18.3874 26.4797 18.4887 26.7355 18.64C26.7726 18.6619 26.7977 18.6985 26.8037 18.7412L27.3716 22.3973C27.3787 22.44 27.3656 22.4827 27.3381 22.5144C27.0236 22.8694 26.6231 23.1244 26.1784 23.2524L25.9644 23.3147L26.0457 23.5269C26.7797 25.4312 28.2718 26.9549 30.1392 27.7039L30.3473 27.7869L30.407 27.5673C30.5326 27.1122 30.7825 26.7036 31.1304 26.384C31.1555 26.3608 31.1889 26.3474 31.2236 26.3474C31.2308 26.3474 31.2392 26.3474 31.2463 26.3498L34.8282 26.9293C34.8712 26.9366 34.9059 26.961 34.9286 26.9988C35.0757 27.2598 35.1749 27.5429 35.2239 27.8393C35.2466 27.9723 35.2586 28.1114 35.2586 28.2577C35.2586 29.6472 34.1491 30.7781 32.7862 30.7805V30.7793Z" fill="#A6CE38"/>
                    <path  d="M42.3244 23.304C42.0338 19.959 40.5322 16.8568 38.0957 14.5695C35.6448 12.2675 32.4634 11 29.1374 11C21.8374 11 15.8979 17.0605 15.8979 24.5093C15.8979 27.0089 16.5733 29.4451 17.8526 31.5665L15 38.0113L24.1364 37.0183C25.7253 37.6819 27.4074 38.0186 29.1374 38.0186C29.5929 38.0186 30.0592 37.9942 30.5266 37.9454C30.9391 37.9003 31.3552 37.8344 31.7652 37.7502C37.8793 36.49 42.3423 30.9529 42.377 24.5813V24.5093C42.377 24.1031 42.359 23.6981 42.3232 23.3053L42.3244 23.304ZM24.4867 34.1893L19.4319 34.7383L20.9419 31.3262L20.6406 30.9126C20.6179 30.8821 20.5964 30.8516 20.5713 30.8175C19.2609 28.9717 18.5687 26.7905 18.5687 24.5081C18.5687 18.561 23.3103 13.7241 29.1374 13.7241C34.5975 13.7241 39.2243 18.0706 39.6702 23.6188C39.6941 23.9164 39.7061 24.2153 39.7061 24.5093C39.7061 24.5935 39.7049 24.6764 39.7025 24.7643C39.5901 29.7391 36.184 33.9636 31.4197 35.0396C31.0563 35.1225 30.6833 35.1847 30.3114 35.2262C29.9253 35.2714 29.5295 35.2933 29.1362 35.2933C27.7362 35.2933 26.3757 35.0164 25.0893 34.4699C24.947 34.4113 24.8071 34.3491 24.6756 34.2845L24.4843 34.1905L24.4867 34.1893Z" fill="#A6CE38"/>
                    </g>
                    <defs>
                    <filter id="filter0_d_2240_1341" x="0" y="0" width="58" height="58" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_2240_1341"/>
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2240_1341" result="shape"/>
                    </filter>
                    </defs>
                </svg>
            </Link>
